...
const create = async (req, res) => {
    ...
    try{
        const total_number_of_documents = await Servicemodel.estimatedDocumentCount()
        ...
        if (total_number_of_documents === undefined || total_number_of_documents === 0) {
            ...
            const find_document_with_user_id = await Servicemodel.find({"Service_id": req.body.Service_id});
